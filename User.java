...
public class User {
        ...
        public User(int id, int phone, String firstname, String lastname, String pass, String email, String photo, Account account) {
                this.id = id;
                this.phone = phone;
        ...
        public static User build(ResultSet rs,AccountsEntity accountsEntity) {
                try {
                        return (new User())
                                ...
                                .setFirstname(rs.getString("user_firstname"))
