...
public class UsersEntity extends BaseEntity {
    ...
    public List<User> findAllOrderByFirstName(AccountsEntity accountsEntity, boolean isAscending) {
        return findByCriteria("true ORDER BY user_firstname" +
    ...
    public boolean add(User user) {
        String sql = "INSERT INTO users(user_id, user_firstname, user_lastname, user_pass, phone, email, photo, account_id) VALUES(" +
                user.getIdAsValue() + ", " +
                user.getFirstname() + ", " +
                user.getLastname() + ", " +
                user.getPass() + ", " +
